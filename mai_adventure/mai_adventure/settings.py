"""
Django settings for mai_adventure project.
...
SECRET_KEY = 'django-insecure-=x6wgnra5cy*%(m-0vj0bnm^h2$jx4!g!j^lz#ys(i3ukrq(d+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['andrekim47.pythonanywhere.com', 'localhost', '127.0.0.1']
#ALLOWED_HOSTS = []
...
ROOT_URLCONF = 'mai_adventure.urls'
...
WSGI_APPLICATION = 'mai_adventure.wsgi.application'
